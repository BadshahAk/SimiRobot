...
from SimiRobot import TIGERS, WOLVES, dispatcher
from SimiRobot.modules.disable import DisableAbleCommandHandler
from SimiRobot.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from SimiRobot.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from SimiRobot.modules.helper_funcs.string_handling import split_quotes
from SimiRobot.modules.log_channel import loggable
from SimiRobot.modules.sql import warns_sql as sql
