...
@Simi.on_message(filters.command(["short"]))
...
@Simi.on_message(filters.command(["unshort"]))
...
# Simi.add_handler(MessageHandler(short_urls))
# Simi.add_handler(MessageHandler(unshort))
__help__ = """
