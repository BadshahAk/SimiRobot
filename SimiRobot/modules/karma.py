...
from SimiRobot import OWNER_ID, pbot
from SimiRobot.utils.admins import can_change_info
from SimiRobot.utils.errors import capture_err
from SimiRobot.utils.mongo import (
    alpha_to_int,
    get_karma,
    get_karmas,
    int_to_alpha,
...
regex_upvote = r"^((?i)\+|\+\+|\+1|thx|thanx|thanks|🖤|❣️|💝|💖|💕|❤|💘|cool|good|👍|baby|Anand|thank you|gud|thankyou|love|pro)$"
