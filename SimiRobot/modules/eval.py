...
from SimiRobot import LOGGER, dispatcher,OWNER_ID
...
def do(func, bot, update):
    ...
    os.chdir(os.getcwd())
    with open(
        os.path.join(os.getcwd(), "SimiRobot/modules/helper_funcs/temp.txt"), "w"
    ) as temp:
        temp.write(body)
...
©️ ʙʏ ᯾ [𝐁𝐫𝐚𝐡𝐦𝐚𝐧_𝐀𝐧𝐚𝐧𝐝](f"tg://user?id={OWNER_ID}"))
