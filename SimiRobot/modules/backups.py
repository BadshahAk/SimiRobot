...
# from SimiRobot.modules.sql import warns_sql as warnssql
import SimiRobot.modules.sql.blacklist_sql as blacklistsql

# from SimiRobot.modules.sql import cust_filters_sql as filtersql
# import SimiRobot.modules.sql.welcome_sql as welcsql
import SimiRobot.modules.sql.locks_sql as locksql
import SimiRobot.modules.sql.notes_sql as sql

# from SimiRobot.modules.rules import get_rules
import SimiRobot.modules.sql.rules_sql as rulessql
from SimiRobot import EVENT_LOGS,OWNER_ID, SUPPORT_CHAT, dispatcher
from SimiRobot.__main__ import DATA_IMPORT
from SimiRobot.modules.connection import connected
from SimiRobot.modules.helper_funcs.alternate import typing_action
from SimiRobot.modules.helper_funcs.chat_status import user_admin
from SimiRobot.modules.sql import disable_sql as disabledsql
...
def export_data(update, context):
    ...
    with open("SimiRobot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SimiRobot{}.backup".format(chat_id), "rb"),
        caption="📤*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SimiRobot-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SimiRobot{}.backup".format(chat_id))  # Cleaning file
