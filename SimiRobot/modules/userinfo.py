...
import SimiRobot.modules.sql.userinfo_sql as sql
...
from SimiRobot import telethn as SimiTelethonClient
from SimiRobot.__main__ import STATS, TOKEN, USER_INFO
from SimiRobot.modules.disable import DisableAbleCommandHandler
from SimiRobot.modules.helper_funcs.chat_status import sudo_plus
from SimiRobot.modules.helper_funcs.extraction import extract_user
from SimiRobot.modules.sql.afk_sql import check_afk_status, is_afk
from SimiRobot.modules.sql.global_bans_sql import is_user_gbanned
from SimiRobot.modules.sql.users_sql import get_user_num_chats
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' \n[<a href="https://t.me/Simibotzone/26">ᴄʟɪᴄᴋ ʜᴇʀᴇ ᴛᴏ ᴋɴᴏᴡ ᴡʜᴀᴛ ɪs ᴅɪsᴀsᴛᴇʀ ʟᴇᴠᴇʟs.</a>]'.format(
            bot.username
        )
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "𝙇𝙀𝙂𝙀𝙉𝘿", url="https://t.me/Brahman_Anand"
                            ),
                            InlineKeyboardButton(
                                "♥️𝑳𝒐𝒗𝒆♥️", url="https://t.me/CHATTINGxGROUP"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
                                text="🎈α∂∂ мє ιη уσυ ¢нαт🎈",
                                url=f"https://t.me/Simi_Ro_bot?startgroup=true",
                            ),
                        ],
                    ]
                ),
            ...
            message.reply_text(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "𝙇𝙀𝙂𝙀𝙉𝘿", url="https://t.me/pandit_Andy"
                            ),
                            InlineKeyboardButton(
                                "♥️𝑳𝒐𝒗𝒆♥️", url="https://t.me/CHATTINGxGROUP"
                            ),
